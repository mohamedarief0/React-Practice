...
const MainHeroSection = () => {
  ...
  function dateUpdate() {
    ...
    return `${date}/ ${day}/ ${getFullYear}`;
  }

  let [currentDate, setCurrentDate] = useState(dateUpdate())
  return (
    <div className="">
      <header className="bg-dark text-light m-0 d-flex justify-content-center p-2">
        <h1>DevOps Essentials {currentDate}</h1>
      </header>

      <section className="mt-2 container">
        <div className="d-flex col--lg-12 align-items-center justify-content-between">
          <div className="col-6 ">
